...
import { MoneyTransferConstant , moneyTransferFeatures} from "@/constants/money-transfer.constants";
...
const MoneyTransfer = () => {
  ...
  return (
    <section className="relative bg-black-100 flex justify-center items-center flex-col overflow-hidden mx-auto sm:px-10 pt-44 ">
      {/* <WobbleCard  className="px-20 min-h-[400px]  lg:min-h-[300px]">
    ...
    <section className="w-full py-20 px-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="Save on transaction costs with our low fees."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          des="Increase flexibility with multi-platform support, allowing you to manage transactions from any device"
        >
          <CanvasRevealEffect
            animationSpeed={3}
