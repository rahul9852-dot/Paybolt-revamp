...
import { instantBankAccountOpeningFeatures, } from "@/constants/instant-banking.constants";
...
const InstantBanking = () => {
  ...
  return (
    <section className="relative bg-black-100 flex justify-center items-center flex-col overflow-hidden mx-auto sm:px-10 pt-44 ">
      <WobbleCard  className="px-20 min-h-[400px] bg-stone-900 lg:min-h-[300px]">
    ...
    <section className="w-full py-20 px-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">        
        <Card
          ...
          des="Enhance customer experience with fast payment processing."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des="Improve security for all transactions"
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          des="Offer multiple payment options to customers"
        >
          <CanvasRevealEffect
            animationSpeed={3}
